...
class trainHandler():
    def __init__(self, height=32, width=900, channels=1, norm_layer=None, use_transformer=True, lr=0.001,
                 data_root_folder=None, train_set=None, training_seqs=None, weights=None):
...
if __name__ == '__main__':
    ...
    train_handler = trainHandler(height=32, width=900, channels=1, norm_layer=None, use_transformer=True, lr=0.00005,
                                 data_root_folder=range_images_folder, train_set=traindata_npzfiles,
                                 training_seqs=training_seqs, weights=weights)
    train_handler.train()
