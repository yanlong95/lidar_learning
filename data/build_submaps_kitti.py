...
if __name__ == '__main__':
    ...
    for sequence in sequences:
        ...
        submaps_euclidean_in_kf_order = compute_submap_keyframes(xyz, xyz_kf, overlaps, top_k=5, overlap_dist_thresh=500.0,
        ...
        submaps_anchor_euclidean_in_kf_order = compute_submap_keyframes(xyz, xyz_kf, overlaps, top_k=5, overlap_dist_thresh=500.0,
                                                            is_anchor=True, metric='euclidean')
        submaps_anchor_overlap_in_kf_order = compute_submap_keyframes(xyz, xyz_kf, overlaps, top_k=5, overlap_dist_thresh=500.0,
        ...
        # save the submaps
        submaps_euclidean_saving_path = os.path.join(submaps_folder, 'euclidean')
        submaps_overlap_saving_path = os.path.join(submaps_folder, 'overlap')
