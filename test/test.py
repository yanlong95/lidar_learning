...
from tools.fileloader import load_files, load_xyz_rot, load_overlaps, load_poses, load_descriptors, read_image
...
class testHandler():
    def __init__(self, params, img_folder, img_kf_folder, frames_poses_path, keyframes_poses_path, weights_path,
        ...
        self.model = OverlapTransformer32(self.height, self.width, self.channels).to(self.device)
    ...
    def compute_descriptors(self, img_paths, model):
    ...
    def test(self):
        ...
        if self.load_descriptors:
            ...
            descriptors = self.compute_descriptors(img_paths, self.model)
